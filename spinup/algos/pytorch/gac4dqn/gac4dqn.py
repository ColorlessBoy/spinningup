...
import gym
import time
import spinup.algos.pytorch.gac4dqn.core as core
...
def gac4dqn(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        steps_per_epoch=1000, epochs=100, replay_size=int(1e5), gamma=0.99, 
        polyak=0.995, pi_lr=1.0, lr=1e-3, batch_size=32, start_steps=1000, 
        update_after=1000, update_every=50, num_test_episodes=10, max_ep_len=1000, 
        logger_kwargs=dict(), save_freq=1, device='cuda', expand_batch=50, alpha=0.0,
    ...
    env = core.EnvWrapper(env)
    test_env = core.EnvWrapper(test_env)
    ...
    ac = actor_critic(obs_dim, feature_dim, act_dim, **ac_kwargs).to(device)
    ac_targ = deepcopy(ac)
    ...
    def compute_loss_pi(data, alpha):
        ...
        o2 = o.repeat(expand_batch, 1, 1, 1)
        a2 = ac.pi(o2)
        q1_pi = ac.q1(o2, a2)
        q2_pi = ac.q2(o2, a2)
