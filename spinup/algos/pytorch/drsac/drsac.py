...
import gym
import time
import spinup.algos.pytorch.drsac.core as core
...
def drsac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    def test_agent():
        for j in range(num_test_episodes):
            ...
            while not(d or (ep_len == max_ep_len)):
                # Take stochastic actions at test time 
                o, r, d, _ = test_env.step(get_action(o, False))
                ep_ret += r
                ep_len += 1
